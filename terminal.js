...
function createTerminal() {
  ...
  term.fit();
  $.post(location.protocol + '//' + location.hostname + ':4243' + '/containers/' + containerId + '/start');

  sockets = new WebSocket(socketDockerURL);
  term.attach(sockets, true, true);
  //term.reset();
  term.write('dododo');
  ...
  //     //socket = new WebSocket(socketDockerURL);
  //     //window.pid = pid;
  //     //socketURL += pid;
